...
if  node['wildfly-clu']['mode']['domain']
 ...
 default['wildfly-clu']['cluster_schema']       = {
					  "myserver1"  => { :role => "domain-controller" , :ip => "33.33.33.111",  :port_offset => "0" },
					  "myserver2"  => { :role => "slave"  , :ip => "33.33.33.112" , :master => "myserver1" , :port_offset => "0"},
					  "myserver3"  => { :role => "slave"  , :ip => "33.33.33.113" , :master => "myserver1" , :port_offset => "0" }
}
